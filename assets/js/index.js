...
function gotoScreen(num) {
  var height = 28;
  $('.iconforscreen' + num + ' .fa').removeClass('invisible').css('opacity', '1.0');
...
function changeImage(num) {
  switch (num) {
    case -1: {
      ...
      break;
    case 0: {
      $('.androidBG .screens').css({ 'background': 'url("img/app/list.jpg") center center no-repeat' })
    }
      break;
    case 1: {
      $('.androidBG .screens').css({ 'background': 'url("img/app/detail.jpg") center center no-repeat' })
    }
      break;
    case 2: {
      $('.androidBG .screens').css({ 'background': 'url("img/app/detail.jpg") center center no-repeat' })
      ...
      break;
    case 3: {
      $('.androidBG .screens').css({ 'background': 'url("img/app/cart.jpg") center center no-repeat' })
    }
      break;
    case 4: {
      $('.androidBG .screens').css({ 'background': 'url("img/app/cart.jpg") center center no-repeat' })
    ...
    case 6: {
      ...
      break;
    case 7: {
      $('.androidBG .screens').css({ 'background': 'url("img/app/cartD.jpg") center center no-repeat' })
    }
      break;
    case 8: {
      $('.androidBG .screens').css({ 'background': 'url("img/app/cartD.jpg") center center no-repeat' })
